...
export default function Experience({
      ...
      <div className="px-4 sm:px-6 md:px-12 lg:px-24">
        ...
        >
          <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light text-white/80 italic leading-relaxed mb-6">
            ""Building solutions through code, learning through experience."
          </p>
  ...
  className="inline-block px-8 py-3 rounded-lg border border-[#00F0FF] text-[#00F0FF] font-mono text-sm uppercase tracking-wider hover:bg-[#00F0FF] hover:text-black transition-all duration-300 cursor-pointer"
