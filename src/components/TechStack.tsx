...
const techRow1 = ["HTML", "CSS", "JavaScript", "React.js", "Bootstrap"];
const techRow2 = ["Python", "Flask", "SQL", "MySQL", "Oracle SQL"];
const techRow3 = ["Git", "GitHub", "OpenCV", "Keras", "CNN", "Machine Learning"];
