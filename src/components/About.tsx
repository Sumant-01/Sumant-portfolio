...
const journeySteps = [
 {
  ...
  year: "2021-Present",
  description:
    "Started my journey in web development, learning HTML, CSS, JavaScript, SQL, and building responsive websites and academic projects.",
  color: "#00F0FF",
  icon: FaRocket,
},
{
  ...
  year: "2024",
  description:
    "Completed a Web Development Internship at Radiant IT Services and gained hands-on experience with React.js, databases, and real-world web applications.",
  color: "#B200FF",
  icon: FaSearch,
},
{
  ...
  year: "2021-2025",
  description:
    "Graduated in AI & Data Science and developed projects including Deepfake Detection, Student Records Management, and Machine Learning-based applications.",
  color: "#00F0FF",
  icon: FaBolt,
},
];
...
const facts = [
  { label: "Years Learning", value: "5+", subtext: "Engineering Journey" },
  { label: "Projects Built", value: "8+", subtext: "From Ideas to Reality" },
  { label: "Technologies", value: "10+", subtext: "Always Learning More" },
  { label: "Certifications", value: "4+", subtext: "Proof of Growth" },
];
      ...
      <div className="px-4 sm:px-6 md:px-12 lg:px-24">
        ...
        <div className="mb-12 sm:mb-16 md:mb-20">
          ...
          <p className="text-white/60 font-light max-w-2xl text-sm sm:text-base">
           An Artificial Intelligence & Data Science graduate passionate about frontend development, software engineering, and building modern web applications.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 mb-16 sm:mb-20">
          ...
          >
            <div className="space-y-4 sm:space-y-5 md:space-y-6">
              {[
                "I'm an Artificial Intelligence & Data Science graduate with a strong passion for software development and frontend engineering. My journey in tech started with web development, where I built responsive websites and worked on projects that strengthened my problem-solving skills.",
                "Over time, I expanded my focus toward React.js, Python, SQL, and modern web technologies. Through internships and personal projects, I have gained hands-on experience in developing web applications, managing databases, and creating practical software solutions.",
                "I believe the best way to learn technology is by building real-world projects. That's why I've worked on projects like a Deepfake Detection System, Student Records Management System, and Salary Prediction System while continuously improving my development skills.",
                "I'm always eager to learn new technologies, collaborate with developers, and contribute to meaningful projects. Let's connect and build something amazing together!"
              ].map((text, index) => (
                <p
                  key={index}
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 mt-8 sm:mt-10">
              <motion.a
                href="https://www.linkedin.com/in/sumant-dhonde/"
                target="_blank"
