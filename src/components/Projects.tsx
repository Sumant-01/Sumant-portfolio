...
const projects = [
  {
    ...
    desc: "Developed a CNN-based deepfake detection system using Python, OpenCV, and Keras. Implemented frame extraction, feature engineering, and dataset balancing techniques, achieving 92% model accuracy.",
    tech: ["Python", "OpenCV", "Keras", "CNN", "TKinter"],
    year: "2025",
    color: "#00F0FF",
    github: "https://github.com/Sumant-01/Deepfake-Video-Detection-System.git",
  },
  {
    title: "Student Records Management System",
    role: "Database Management",
    desc: "Designed and implemented a relational database system with CRUD operations and role-based access control. Built to efficiently manage student records and administrative tasks." ,
    tech: ["SQL", "Bootstrap", "APIs", "JavaScript"],
    year: "2024",
    color: "#B200FF",
  ...
  },
  {
    ...
    desc: "Built a salary prediction model using machine learning and integrated it into a Flask-based web application for real-time salary estimation.",
    tech: ["Python", "Flask", "HTML", "CSS", "JavaScript"],
    year: "2024",
    color: "#00F0FF",
    github: "https://github.com/Sumant-01/Salary-Prediction-Model.git",
  },
  {
  title: "BMW India Clone",
  role: "Frontend Development",
  desc: "Built a responsive clone of the BMW India website using HTML and CSS. Implemented a clean layout, CSS-only navigation, and responsive design while focusing on pixel-perfect UI replication and user experience.",
  tech: ["HTML", "CSS", "Responsive Design", "JavaScript"],
  year: "2025",
  color: "#B200FF",
  github: "https://github.com/Sumant-01/BMW-IN-Clone",
},
{
  title: "Music Player",
  role: "JavaScript Application",
  desc: "Developed an interactive music player with audio controls, playlist management, and responsive user interface. Focused on JavaScript functionality, media handling, and smooth user experience.",
  tech: ["HTML", "CSS", "JavaScript"],
  year: "2024",
  color: "#00F0FF",
  github: "https://github.com/Sumant-01/Music-Player",
},
{
  title: "Agro Product Website",
  role: "Responsive Web Development",
  desc: "Created a responsive agriculture-focused website showcasing agro products. Designed with mobile-friendly layouts and modern UI principles using HTML and CSS.",
  tech: ["HTML", "CSS", "Responsive Design"],
  year: "2023-24",
  color: "#B200FF",
  github: "https://github.com/Sumant-01/Agro-Product",
},
];
